                ...
                <v-card-text class="as-flex-profile" v-if="loading_profile == false">
                    ...
                    <v-table density="compact" class="as-item-profile">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2" class="text-center text-h6">Credenciales de acceso</td>
                            </tr>
                        </tbody>
                    </v-table>
                    ...
                    <v-form @submit.prevent="saveCredentials" class="as-item-profile">
                        ...
                        <v-text-field v-model="credentials.confirm_new_password" :readonly="loading_save_credentials"
                            prepend-inner-icon='mdi-lock' label="Confirmar contraseña"
                            placeholder="Escriba su contraseña..." color="blue-darken-3"
                            :append-inner-icon="show_confirm_new_password ? 'mdi-eye' : 'mdi-eye-off'"
